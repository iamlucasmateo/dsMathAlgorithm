...
SELECT b.facid,name,SUM(slots) 
FROM cd.bookings b,cd.facilities f
WHERE b.facid = f.facid
AND b.starttime BETWEEN '2012-09-01' AND '2012-09-30'
GROUP BY b.facid,f.facid,name
ORDER BY b.facid
...
FROM cd.bookings
WHERE starttime BETWEEN '2012-09-21 00:00' AND '2012-09-21 23:59'
ORDER BY starttime

-- 15)	How can you produce a list of the start times for bookings by members named 'David Farrell'?

SELECT b.memid,m.firstname,m.surname,b.starttime
